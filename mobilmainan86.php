...
echo color("yellow","[]          RAILING DEPO             \n");
...
function change(){
        ...
        echo "\n".color("yellow","!] Claim voc ANAK KOCOK");
        ...
        sleep(3);
        $boba19 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"RAMADHAN60"}');
        ...
        sleep(3);
        $boba11 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOJ3KAMAN"}');
        ...
        echo "\n".color("green","+] Message: ".$messageboba11);
        goride:
        echo "\n".color("yellow","!] Claim voc PAKAIGOFOOD0906");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        ...
        sleep(3);
        $goride = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PAKAIGOFOOD0906"}');
